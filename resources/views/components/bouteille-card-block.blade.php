    ...
    <a href="{{ route('catalogue.show', $id) }}" class="flex flex-col" aria-label="Voir les détails de {{ $nom }}">
        ...
        <a href="{{ route('bouteilles.show', [$cellierId, $bouteilleId]) }}" class="flex flex-col" aria-label="Voir les détails de {{ $nom }}">
            ...
            <picture class='w-full h-32 overflow-hidden bg-neutral-400 flex items-center justify-center cursor-pointer relative'>
                @if ($image === null)
                <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="90.000000pt" height="90.000000pt" viewBox="0 0 300.000000 300.000000" preserveAspectRatio="xMidYMid meet">
                    <g transform="translate(0.000000,300.000000) scale(0.050000,-0.050000)" fill="#757575" stroke="none">
